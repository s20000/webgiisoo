...
insert into tbluser(id, name, certid, nickname, password, created) values(0, 'admin', '123456', 'admin', 'albqdj2cd1aun', 0);
...
insert into tblaccess(name, id) values('access.admin', 'access.admin');
...
create unique index tblroleaccess_index_rid_name on tblroleaccess(rid, name);
...
insert into tbldict(id, name, display) values('root', 'root', '字典数据库'); 
