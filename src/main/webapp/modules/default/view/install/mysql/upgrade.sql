...
alter table tblconfig add name1 varchar(255);
update tblconfig set name1=name;
alter table tblconfig drop name;
alter table tblconfig add name varchar(255);
update tblconfig set name=name1;
alter table tblconfig drop name1;
