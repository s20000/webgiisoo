 ...
 * web api: /svg
 * <p>
 * used to create a svg file and download
 * 
 * @author joe
 *
 */
public class svg extends Model {
    ...
    public void download() {
        try {
            ...
            if (ChartsType.image_svg_xml.getChartsTypeName().equalsIgnoreCase(type)) {
                ...
                setHeader(ChartsType.content_Disposition.getChartsTypeName(), ChartsType.attachment.getChartsTypeName() + fileName);
    ...
    public enum ChartsType {
        ...
        image_png("image/png"), image_jpeg("image/jpeg"), image_svg_xml("image/svg+xml"), contentType("application/x-download"), content_Disposition("Content-Disposition"), attachment(
                "attachment;filename=");
