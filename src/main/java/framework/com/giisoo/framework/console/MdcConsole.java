...
public class MdcConsole {
	...
	public static void main(String[] args) {
		try {
			...
			MdcConsole mdc = new MdcConsole();
			mdc.host = conf.getString("mdc.server", "mdc.giisoo.com");
	...
	static void testMdc() {
		...
		try {
			...
			final TConn c = TConn.connectByTcp("mdc.giisoo.com", 1099, r);
			r.setC(c);
