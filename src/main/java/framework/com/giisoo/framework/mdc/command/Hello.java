    ...
    public boolean onRequest(Request in, Response out, TConn d) {
        ...
        try {
            ...
            if (d.load(clientid)) {
                ...
                log.debug("clientid:" + clientid + ", uid:" + uid + "-" + d.getRemoteIp());
                ...
                if (d.validate(uid)) {
                    ...
                    log.info("uid:" + uid + ", code:" + code + ", pubkey:" + d.getKey());
                    ...
                    d.update(V.create("capability", d.getCapability()).set("ip", d.getRemoteIp()));
