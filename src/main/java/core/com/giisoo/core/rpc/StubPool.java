...
public class StubPool {
    ...
    /**
     * linkedlist is better than arraylist due to frequently remove/add elements
     * from/in it.
     */
    ...
    /**
     * get a stub from pool, return an available stub or null until trying
     * attempt_times;.
     *
     * @return the stub
     * @throws IOException
    ...
    /**
     * trying to get one, and return immediately, null will be return if not
     * available.
     *
     * @return the stub
     */
    ...
    /**
     * there is a bug there. in case of: a stub is in use and it doesn't present
     * in the list
     */
    public void close() {
        synchronized (stubMap) {
